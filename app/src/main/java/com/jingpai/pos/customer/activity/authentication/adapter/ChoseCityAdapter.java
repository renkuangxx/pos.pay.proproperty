 ...
 * @author 86173
 */
public class ChoseCityAdapter extends BaseAdapter implements Filterable {
    ...
    public ChoseCityAdapter(List<City> list, Context context, FilterListener filterListener) {
        this.cityList = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        list.clear();
        list.add(cityList.get(position).getName());
