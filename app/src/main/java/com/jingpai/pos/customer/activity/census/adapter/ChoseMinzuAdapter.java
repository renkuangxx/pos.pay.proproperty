 ...
 * @author 86173
 */
public class ChoseMinzuAdapter extends BaseAdapter implements Filterable {
    ...
    public ChoseMinzuAdapter(List<String> list, Context context, FilterListener filterListener) {
        this.list = list;
