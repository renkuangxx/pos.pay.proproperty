package com.jingpai.pos.customer.activity.qrcode;
...
//        setTitle("扫描结果为：" + result);
        vibrate();
        Intent intent=null;
        if (result.contains("jphl.com")){
            intent = new Intent(this, CityLifeWebViewActivity.class);
...
//			intent.putExtra(Constant.WEB_TITLE,mSplashBean.getName());
            ...
            if (result.startsWith("http")||result.startsWith("https")){
                ...
                ToastUtils.INSTANCE.showToast("您扫描的二维码为非链接");
            }
