...
public class BillHistoryAdapter extends BaseQuickAdapter<BillHistoryBean, BaseViewHolder> {
    private Context myContext;
    public BillHistoryAdapter(Context context,int layoutResId, @Nullable List<BillHistoryBean> data) {
    ...
    protected void convert(BaseViewHolder helper, BillHistoryBean item) {
        ...
        helper.getView(R.id.tv_detail).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("state", item.getInvoiceBool());
