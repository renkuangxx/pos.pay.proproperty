 ...
 * 功能:
 */
public class PickerScrollNewView extends View {

    public static final String TAG = "PickerScrollNewView:";
    /**
    ...
    public InfoBean getSelectedInfo() {
    ...
    public PickerScrollNewView(Context context) {
        super(context);
        init();
    }

    public PickerScrollNewView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void moveHeadToTail() {
        InfoBean info = mDataList.get(0);
        mDataList.remove(0);
        mDataList.add(info);
    }

    private void moveTailToHead() {
        InfoBean info = mDataList.get(mDataList.size() - 1);
    ...
    private void drawData(Canvas canvas) {
        ...
        // text居中绘制，baseline的计算才能达到居中，y值是text中心坐标
        ...
        InfoBean info = mDataList.get(index);
        String textData = info.getInfo();
    ...
    private void drawOtherText(Canvas canvas, int position, int type) {
        ...
        InfoBean house = mDataList.get(index);
        String textData = house.getInfo();
    ...
    public interface onSelectListener {
        void onSelect(InfoBean pickers);
    }
}