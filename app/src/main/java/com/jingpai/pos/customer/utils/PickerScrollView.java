...
public class PickerScrollView extends View {
    ...
    private List<BuildingBean.DataBean> mDataList;
    /**
    ...
    public void setData(List<BuildingBean.DataBean> data) {
        mDataList = data;
    ...
    private void moveHeadToTail() {
        BuildingBean.DataBean dataBean = mDataList.get(0);
        mDataList.remove(0);
        mDataList.add(dataBean);
    }

    private void moveTailToHead() {
        BuildingBean.DataBean dataBean = mDataList.get(mDataList.size() - 1);
    ...
    private void drawData(Canvas canvas) {
        ...
        BuildingBean.DataBean house = mDataList.get(index);
        String textData = house.getHouseName();
    ...
    public interface onSelectListener {
        void onSelect(BuildingBean.DataBean pickers);
    }
}